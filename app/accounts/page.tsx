  ...
  return (
    <AppLayout>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm mb-8">
        ...
        <p className="text-sm text-gray-500 mt-2">{accounts.length} account(s) registered</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-500 mt-2">Create your first bank account to get started</p>
        </div>
      ) : (
